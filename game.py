...
def alignement(grid,x,y):
    ...
    if((grid[x][0] != None) and (grid[x][1] != None) and  (grid[x][2]!= None) and (grid[x][3] != None) and (grid[x][4] != None) and (grid[x][5]  != None)):  
        ...
        if (grid[x][0] != None) and (grid[x][1] != None) and  (grid[x][2]!= None) and (grid[x][3] == None) and (grid[x][4] == None) and (grid[x][5] == None) :
            score+=3
            #print("1horizontal 3")
        elif (grid[x][0] == None) and (grid[x][1] != None) and  (grid[x][2]!= None) and (grid[x][3] != None) and (grid[x][4] == None) and (grid[x][5] == None) :
            score+=3
            #print("2horizontal 3")
        elif (grid[x][0] == None) and (grid[x][1] == None) and (grid[x][2] != None) and  (grid[x][3]!= None) and (grid[x][4] != None) and (grid[x][5] == None):
            score+=3
    ...
    if((grid[0][y] != None) and (grid[1][y] != None) and (grid[2][y] != None) and (grid[3][y] != None) and (grid[4][y]!= None) and (grid[5][y]!= None)):
        ...
        if (grid[0][y] != None) and (grid[1][y] != None) and  (grid[2][y]!= None) and (grid[3][y] == None) and (grid[4][y] == None) and (grid[5][y] == None) :
            score+=3
            #print("1vertical 3")
        elif (grid[0][y] == None) and (grid[1][y] != None) and  (grid[2][y]!= None) and (grid[3][y] != None) and (grid[4][y] == None) and (grid[5][y] == None) :
            score+=3
            #print("2vertical 3")
        elif (grid[0][y] == None) and (grid[1][y] == None) and (grid[2][y] != None) and  (grid[3][y]!= None) and (grid[4][y] != None) and (grid[5][y] == None):
            score+=3
